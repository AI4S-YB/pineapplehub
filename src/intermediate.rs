        ...
        sipper(async move |mut sender| {
            ...
            match self.current_step {
                ...
                Step::BinaryFusion => {
                    ...
                    let (_, roi_rect_low_res) =
                        extract_best_roi(smoothed, &image, px_per_mm, contours)?;
...
fn perform_scale_calibration(
    ...
    let mut best_coin: Option<(f32, Vec<Point<i32>>)> = None; // (hull_area, hull_points)
